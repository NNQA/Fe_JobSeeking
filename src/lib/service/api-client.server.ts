...
export class ApiClient {
  ...
  protected static _baseUrl: String | undefined =
  ...
  protected fetch(
    input: string | URL,
    { headers, ...options }: RequestApiOptions = {}
  ...
  public put(input: string | URL, option?: RequestApiOptions) {
    return this.fetch(input, {
      ...option,
      method: "PUT",
    });
  ...
  public delete(input: string | URL, option?: RequestApiOptions) {
    return this.fetch(input, {
      ...option,
      method: "DELETE",
    });
